...
if(isset($_GET['Reject'])){
	...
	mysqli_query($con, "UPDATE tbl_qs SET Status = '14' WHERE Id = '$quoteno'")or die(mysqli_error($con));
}
  ...
  <div id="right-container">
    <form id="form1" name="form1" method="post" action="../fpdf/pdf-rfq.php">
      ...
      <?php if($numrows >= 1){ ?>
        ...
        <tr>
          <td width="60" nowrap="nowrap" class="td-header-blue-dark">Quote No.</td>
          <td width="172" class="td-header-blue-dark">Company Name</td>
          <td width="172" class="td-header-blue-dark">Enquired By</td>
        ...
        <tr>
          ...
          <td align="center" class="td-grey" title="View">
            <a href="../fpdf/pdf-qs.php?Id=<?php echo $row_qued['Id']; ?>&Preview&Type=2" target="_blank" class="pdf"></a>
          </td>
          <td align="center" class="td-grey" title="View">
            <a href="<?php approve($con,$row_qued['Id']); ?>" class="approve" title="Approve Quote"></a>
          </td><td align="center" class="td-grey" title="View">
            <a href="submitted.php?Reject=<?php echo $row_qued['Id']; ?>" class="reject" title="Reject Quote"></a></td>
        </tr>
        <?php } ?>
        <tr>
          <td colspan="10">
