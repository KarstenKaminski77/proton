...
if(isset($_POST['calculate'])){
	...
	for($i=0;$i<count($_POST['id']);$i++){
		...
		mysqli_query($con, "UPDATE tbl_qs_items SET Qty = '$qty', Unit = '$unit', Price = '$price', Total = '$total' WHERE Id = '$id'")or die(mysqli_error($con));
	...
	mysqli_query($con, "UPDATE tbl_qs SET DeliveryTerms = '$terms_d', DeliveryDate = '$delivery_date', ExpiryDate = '$expire', PaymentTerms = '$terms_p', SpecialConditions = '$conditions' 
  ...
  <div id="right-container">
    <form id="form1" name="form1" method="post" action="">
      <div id="breadcrumbs">
        ...
        <tr>
          <td align="right" class="td-header-blue">Sub Total</td>
          <td align="right" class="td-header-blue">R<?php qs_subtotal($con, $quoteno); ?></td>
        </tr>
        <tr>
          <td align="right" class="td-header-blue-dark">Transport</td>
          <td align="right" class="td-header-blue-dark">R<?php echo number_format($row_transport['Price'],2); ?></td>
        </tr>
        <tr>
