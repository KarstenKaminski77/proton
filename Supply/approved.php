...
if(isset($_GET['Invoice']) && isset($_POST['create'])){
	...
	VALUES ('$rfqno','$quoteno','$company','$po','$date','$due_date','$terms','2','$currency')")or die(mysqli_error($con));
	...
	header('Location: ../fpdf/pdf-inv-supply.php?Id='. $invoiceno .'&Quote='. $quoteno);
}
...
$query_due = mysqli_query($con, "SELECT * FROM tbl_qs WHERE Id = '$quoteno'")or die(mysqli_error($con));
$row_due = mysqli_fetch_array($query_due);
?>
    ...
    <form id="form1" name="form1" method="post" action="">
      ...
      <div style="margin-bottom:20px">
        <table width="760" border="0" align="center" cellpadding="0" cellspacing="1">
          ...
          <tr>
            <td class="td-grey"><input name="terms" type="text" class="tarea-100" id="terms" value="<?php echo $row_due['PaymentTerms']; ?>" /></td>
            <td class="td-grey"><input name="due-date" type="text" class="tarea-100" id="due-date" value="<?php echo $row_due['ExpiryDate']; ?>" /></td>
