...
<div id="container">
  ...
  <div id="right-container">
    <form id="form1" name="form1" method="post" action="../fpdf/pdf-rfq.php">
          ...
          <tr>
            <td colspan="2" class="tab"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td><img src="../images/icons/bread-crumb.png" width="45" height="35" /></td>
                  <td><a href="../Admin/Industries/index.php" class="breadcumbs">Rejected</a></td>
                  <td><img src="../images/icons/bread-crumb.png" width="45" height="35" /></td>
                </tr>
            </table></td>
          </tr>
      ...
      <?php if($numrows >= 1){ ?>
        ...
        <tr>
          ...
          <td align="center" class="td-grey" title="View">
            <a href="../fpdf/pdf-qs.php?Id=<?php echo $row_qued['Id']; ?>&Preview" target="_blank" class="pdf"></a>          <script>
			 function myFunction<?php echo $row_qued['Id']; ?>() {
				 
				 var orderno = prompt("Please Enter Your PO Number");
				 
				 if (orderno != null) {
					 
					 window.location.href = "submitted.php?Id=<?php echo $row_qued['Id']; ?>&PO=" + orderno; 
				 }
			 }
             </script>          </td>
          </tr>
      ...
      <?php } else { ?>
      <div align="center" class="welcome">Currently no rejected quotes...</div>
<?php } ?>
    </form>
  </div>
</div>
