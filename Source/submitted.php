...
if(isset($_GET['Reject'])){
	...
	mysqli_query($con, "UPDATE tbl_qs SET Status = '4' WHERE Id = '$quoteno'")or die(mysqli_error($con));
}
  ...
  <div id="right-container">
      ...
      <?php if($numrows >= 1){ ?>
        ...
        <tr>
          ...
          <td width="167" class="td-header-blue-dark">Enquired By</td>
        ...
        <tr>
          ...
          <td align="center" class="td-grey" title="View">
            <a href="../fpdf/pdf-qs.php?Id=<?php echo $row_qued['Id']; ?>&Preview" target="_blank" class="pdf"></a>
          </td>
          <td align="center" class="td-grey" title="View">
