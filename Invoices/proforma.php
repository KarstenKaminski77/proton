...
if(isset($_GET['Id'])){
	...
	header('Location: ../Source/po-no.php?Id='. $quoteno);
}
      ...
      <?php if($numrows >= 1){ ?>
        ...
        <tr>
          ...
          <td align="center" class="td-grey" title="View">
            <a href="../fpdf/pdf-proforma.php?Id=<?php echo $row_proforma['Id']; ?>&Preview" target="_blank" class="pdf"></a>          </td>
          <td align="center" class="td-grey" title="View">
            <a href="proforma.php?Id=<?php echo $row_proforma['Id']; ?>&QuoteNo=<?php echo $row_proforma['QuoteNo']; ?>" class="approve" title="Paid"></a>
          </td>
        </tr>
        <?php } ?>
        <tr>
