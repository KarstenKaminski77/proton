...
$query_po = mysqli_query($con, "SELECT * FROM tbl_po WHERE RFQNo = '$rfqno'")or die(mysqli_error($con));
...
if(isset($_GET['Preview'])){
	...
	$pdf = 'Proton Chem Purchase Order #'.$pono.'.pdf';
		
	mysqli_query($con, "UPDATE tbl_po SET PDF = '$pdf' WHERE Id = '$pono'")or die(mysqli_error($con));
...
header('Location:pdf/mail-po.php?Id='. $rfqno);
}
