...
if(isset($_GET['Preview'])){
	...
	mysqli_query($con, "UPDATE tbl_notes SET DeliveryNote = '$pdf', Date = '$date', Status = '1' WHERE Id = '$id'")or die(mysqli_error($con));
...
header('Location:pdf/mail-notes-supply.php?Id='. $pono);
