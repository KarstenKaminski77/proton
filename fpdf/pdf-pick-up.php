...
SELECT
	...
	tbl_transport_companies.Email AS Email_1,
	tbl_transport_companies.Telephone AS Telephone_1,
	tbl_transport_companies.Fax AS Fax_1,
	tbl_transport_companies.Mobile AS Mobile_1
FROM
	tbl_po
...
$aRow[3]['BORDER_TYPE'] = 'LRTB';
$aRow[3]['TEXT'] = $row_pickup['Email_1']; 
$aRow[3]['BACKGROUND_COLOR'] = array(255,255,255);
$aRow[3]['TEXT_COLOR'] = array(0,0,0);
$aRow[3]['TEXT_TYPE'] = '';
$aRow[3]['BORDER_COLOR'] = array(102,102,102);
...
if(isset($_GET['Preview'])){
	...
	mysqli_query($con, "INSERT INTO tbl_notes (POId,QuoteNo,TranporterId,PickUpSlip,Type) VALUES ('$pono','$quoteno','$transportid','$pdf','1')")or die(mysqli_error($con));
...
header('Location: pdf-delivery.php?Id='. $pono);
