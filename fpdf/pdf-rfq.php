...
for($x=0;$x<count($_POST['supplier']);$x++){

	$supplierid = $_POST['supplier'][$x];
	...
	$aRow[4]['TEXT_COLOR'] = array(102,102,102);
	$aRow[4]['TEXT_TYPE'] = 'B';
	...
	$aRow[3]['BORDER_TYPE'] = 'LRTB';
	$aRow[3]['TEXT'] = $row_products['PackSize'];
	$aRow[3]['TEXT_ALIGN'] = "L";
	$aRow[3]['BORDER_COLOR'] = array(102,102,102);

	$aRow[4]['BORDER_TYPE'] = 'LRTB';
	$aRow[4]['TEXT'] = $row_products['Grade'];
	$aRow[4]['BORDER_COLOR'] = array(102,102,102);
	$aRow[4]['TEXT_ALIGN'] = 'L';
	...
	if(isset($_GET['Preview'])){
		...
		$pdf = 'Proton Chem RFQ #'.$sourceid.'.'.$x.'.pdf';

		mysqli_query($con, "UPDATE tbl_rfq_items SET RFQ = '1', PDF = '$pdf' WHERE SourceId = '$sourceid' AND SupplierId = '$supplierid'")or die(mysqli_error($con));
...
$_SESSION['supplierid'] = $supplier;

header('Location:pdf/mail-rfq.php?Id='. $sourceid);
