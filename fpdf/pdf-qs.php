...
qs_pdf_subtotal($con, $quoteno);
qs_pdf_vat($con, $quoteno, $transport);
qs_pdf_total($con, $quoteno, $transport);
...
$aRow[1]['BORDER_TYPE'] = 'LRTB';
$aRow[1]['TEXT'] = $row_quote_to['BuyerName']; 
$aRow[1]['BACKGROUND_COLOR'] = array(255,255,255);
$aRow[1]['TEXT_COLOR'] = array(0,0,0);
$aRow[1]['TEXT_TYPE'] = '';
$aRow[1]['BORDER_COLOR'] = array(102,102,102);
...
$aRow[3]['BORDER_TYPE'] = 'LRTB';
$aRow[3]['TEXT'] = $row_quote_to['BuyerEmail']; 
$aRow[3]['BACKGROUND_COLOR'] = array(255,255,255);
$aRow[3]['TEXT_COLOR'] = array(0,0,0);
$aRow[3]['TEXT_TYPE'] = '';
$aRow[3]['BORDER_COLOR'] = array(102,102,102);
...
$oPdf->MultiCell(190,7, 'Dear ' .$row_quote_to['BuyerName'] .'
'. $_SESSION['content'],'','L');
$oPdf->Ln(10);
...
while($row_products = mysqli_fetch_array($query_products)){
	...
	$aRow[3]['BORDER_TYPE'] = 'LRTB';
	$aRow[3]['TEXT'] = $row_quote_to['Currency'] .' '. $row_products['Retail']; 
	$aRow[3]['BORDER_COLOR'] = array(102,102,102);
	$aRow[3]['TEXT_ALIGN'] = 'R';

	$aRow[4]['BORDER_TYPE'] = 'LRTB';
	$aRow[4]['TEXT'] = $row_quote_to['Currency'] .' '. $row_products['Total']; 
	$aRow[4]['BORDER_COLOR'] = array(102,102,102);
	$aRow[4]['TEXT_ALIGN'] = 'R';
...
$aRow[4]['BORDER_TYPE'] = 'LRTB';
$aRow[4]['TEXT'] = $row_quote_to['Currency'] .'&nbsp;'. $_SESSION['subtotal']; 
$aRow[4]['BACKGROUND_COLOR'] = array(227,227,227);
$aRow[4]['TEXT_COLOR'] = array(0,0,0);
$aRow[4]['TEXT_TYPE'] = '';
$aRow[4]['BORDER_COLOR'] = array(102,102,102);
...
$aRow[4]['BORDER_TYPE'] = 'LRTB';
$aRow[4]['TEXT'] = $row_quote_to['Currency'] .' '. $_SESSION['vat']; 
$aRow[4]['BACKGROUND_COLOR'] = array(227,227,227);
$aRow[4]['TEXT_COLOR'] = array(0,0,0);
$aRow[4]['TEXT_TYPE'] = '';
$aRow[4]['BORDER_COLOR'] = array(102,102,102);
...
$aRow[4]['BORDER_TYPE'] = 'LRTB';
$aRow[4]['TEXT'] = $row_quote_to['Currency'] .' '. $_SESSION['total']; 
$aRow[4]['BACKGROUND_COLOR'] = array(227,227,227);
$aRow[4]['TEXT_COLOR'] = array(0,0,0);
$aRow[4]['TEXT_TYPE'] = '';
$aRow[4]['BORDER_COLOR'] = array(102,102,102);
...
$aRow[3]['BORDER_TYPE'] = 'LRTB';
$aRow[3]['TEXT'] = $row_quote_to['ExpiryDate']; 
$aRow[3]['BACKGROUND_COLOR'] = array(255,255,255);
$aRow[3]['TEXT_COLOR'] = array(0,0,0);
$aRow[3]['TEXT_TYPE'] = '';
$aRow[3]['BORDER_COLOR'] = array(102,102,102);
...
$oPdf->SetTextColor(0,0,0);
$oPdf->SetFont('Arial','',9);
$oPdf->Multicell(190,'6',$_SESSION['content'],'','L');
...
if(isset($_GET['Preview'])){
	...
	$pdf = 'Proton Chem Quotation #'.$quoteno.'.pdf';
		
	mysqli_query($con, "UPDATE tbl_qs SET PDF = '$pdf' WHERE Id = '$quoteno'")or die(mysqli_error($con));
	...
	header('Location:pdf/mail-qs.php?Id='. $quoteno .'&Company='. $row_quote_to['CompanyId'].$param);
