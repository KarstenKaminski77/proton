  ...
  <div align="center" class="welcome" id="right-container">
    <form id="form1" name="form1" method="post" action="">
      ...
      <table width="100%" border="0" cellpadding="4" cellspacing="1">
        <tr>
          <td width="150" class="td-header-blue-dark">Date</td>
          <td class="td-header-blue-dark">Subject</td>
          <td width="150" class="td-header-blue-dark">Undustry</td>
          <td width="22" class="td-header-blue-dark">&nbsp;</td>
        </tr>
        <?php while($row_sent = mysqli_fetch_array($query_sent)){ ?>
        <tr>
          <td class="td-grey"><?php echo $row_sent['Date']; ?></td>
          <td class="td-grey"><?php echo $row_sent['Subject']; ?></td>
          <td class="td-grey"><?php echo $row_sent['Industry']; ?></td>
          <td class="td-grey"><a href="sent-details.php?Id=<?php echo $row_sent['Id']; ?>" class="search"></a></td>
        </tr>
        <?php } ?>
        <tr>
          <td colspan="4" class="td-right">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="5" align="right"><input name="send" type="submit" class="btn" id="send" value="Send Email" /></td>
        </tr>
      </table>
    </form>
  </div>
