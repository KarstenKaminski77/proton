    ...
    <form id="form1" name="form1" method="post" action="../fpdf/pdf-rfq.php">
          ...
          <tr>
            <td colspan="2" class="tab"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td><img src="../images/icons/bread-crumb.png" width="45" height="35" /></td>
                  <td><a href="../Admin/Industries/index.php" class="breadcumbs">Pick Up Notes | Delivery Slips</a></td>
                  <td><img src="../images/icons/bread-crumb.png" width="45" height="35" /></td>
                </tr>
            </table></td>
          </tr>
      ...
      <?php if($numrows >= 1){ ?>
        ...
        <tr>
          ...
          <td width="252" class="td-header-blue-dark">Customer</td>
        ...
        <tr>
          ...
          <td width="22" align="center" class="td-grey" title="View">
            <a href="../fpdf/pdf-pick-up-supply.php?Id=<?php echo $row_po['Id']; ?>&Preview" class="pdf" title="Pick Up Slip" target="_blank"></a>
          </td>
          <td width="22" align="center" class="td-grey" title="View">
            <a href="../fpdf/pdf-delivery-supply.php?Id=<?php echo $row_po['Id']; ?>&Preview" class="pdf" title="Delivery Note" target="_blank"></a>
          </td>
          </tr>
        <?php } ?>
        <tr>
