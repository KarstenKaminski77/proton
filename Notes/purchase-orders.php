...
WHERE tbl_po.Status = '1' AND Type = '2'
ORDER BY tbl_po.Date ASC, tbl_po.Id DESC";
    ...
    <form id="form1" name="form1" method="post" action="../fpdf/pdf-rfq.php">
      ...
      <?php if($numrows >= 1){ ?>
        ...
        <tr>
          ...
          <td width="22" align="center" class="td-grey" title="View">
            <a href="../fpdf/pdf-pick-up.php?Id=<?php echo $row_po['Id']; ?>" class="delivery" title="Delivery Notes | Pick Up Slips"></a>
          </td>
          </tr>
        <?php } ?>
        <tr>
